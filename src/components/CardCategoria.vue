...
export default{
    ...
    methods: {
      requireImage ():string {
        return new URL(`../assets/categorias_ingredientes/${this.categoria.imagem}`, import.meta.url).href;
      }
    },
...
<template>
  <article class="categoria">
    <header class="categoria__cabecalho">
      <img :src="requireImage()" class="categoria__imagem" alt="">

      <h2 class="paragrafo-lg categoria__nome">{{ categoria.nome }}</h2>
  
    </header>
    <ul class="categoria__ingredientes">
      <li v-for="ingrediente in categoria.ingredientes" :key="ingrediente" onmouseup="">
